...
<div id="web-form" class="form-group">
    <fieldset>
        <form action="/add.php" class="form-content" method="post">
            <h5>
                <label for="name" class="business_name">Business name: </label>
                    <input type="text" id="name" name="name" placeholder="PhyCear ">
                <br>
                <label for="phone" class="business_phone">Phonenumber: </label>
                    <input type="tel" id="phone" name="phone" placeholder="+7-903-665-33-32">
                <br>
                <label for="category" class="business_category">Business category: </label>
